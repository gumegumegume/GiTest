...
<div id="form-block">
    ...
    <br>
        ...
        <input type="address"  id="address" class="input" name="address" value="<?php echo $user->get_user_address($id);?>" placeholder="Your Address">
        
        <label for="contactnumber">Contact Number</label>
        <input type="tel"  id="contactnumber" class="input" name="contactnumber"  minlength="11" maxlength="11" value="<?php echo $user->get_user_number($id);?>" placeholder="Your Contact Number">
